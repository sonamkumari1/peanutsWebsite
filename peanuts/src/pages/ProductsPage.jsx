  ...
  return (
    <div className="bg-[#fff7ff]">
      ...
      <div>
        ...
        {/* Product Block 2 */}
        <div className="w-full flex flex-col-reverse md:flex-row-reverse items-start md:px-40 px-4 py-8 gap-10 text-gray-800">
        ...
        <div className="w-full flex flex-col md:flex-row items-start md:px-40 px-4 md:py-24 py-8 gap-10 text-gray-800">
          <div className="w-full md:w-1/2 px-4 md:px-10 bg-[#fff7ff] border border-gray-100 shadow-xl">
            ...
            <p className="text-base mt-4 mb-7">
              ...
              spheroidal shape with pink skin color. We have JAVA variety
              peanuts with available sizes of 50/60, 60/70, 70/80, 80/90. Bold
              variety peanuts are rich in nutrients, over 30 essential nutrients
              & phytonutrients are discovered in bold peanuts, they are also
              good source of niacin, foliate, fibre, magnesium, vitamin E,
              manganese & phosphorous. They also are naturally free of
              trans-fats and sodium and contain about 25% protein.
            </p>
          </div>
          <div className="w-full md:w-1/2">
            <img
        ...
        <div className="w-full flex flex-col-reverse md:flex-row-reverse items-start md:px-40 px-4 py-8 gap-10 text-gray-800">
          ...
          <div className="w-full md:w-1/2 order-2 md:order-1 px-4 md:px-7 bg-[#fff7ff] border border-gray-100 shadow-xl">
            <h3 className="text-2xl font-bold mt-5">Roasted Peanuts Whole</h3>
            <p className="text-base mt-5 mb-9">
              We are engaged in offering the best quality range of Roasted
              Peanuts White Plain (Whole). Our roasted peanuts are very popular
              among our clients for its sumptuous taste and premium quality. The
              peanuts are processed by highly skilled labour under supervision
              of professionals using advanced machines.
              <br /> Roasted Peanuts White Plain (Whole) is available in size of
              40/50, 50/60.
            </p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row items-start md:px-40 px-4 md:py-24 py-8 gap-10 text-gray-800">
          <div className="w-full md:w-1/2 p-4 md:p-7 bg-[#fff7ff] border border-gray-100 shadow-xl">
            ...
            <p className="text-base">
              ...
              taste and that’s why widely applauded in market.
              <br /> Available sizes of Roasted Splits White – 40/50, 50/60 and
              60/70.
            </p>
          </div>
          <div className="w-full md:w-1/2">
        ...
        {/* Product Block 6 */}
        <div className="w-full flex flex-col-reverse md:flex-row items-start md:px-40 px-4 py-8 gap-10 text-gray-800">
          <div className="w-full md:w-1/2">
            <img
          ...
          <div className="w-full md:w-1/2 p-4 md:p-7 bg-[#fff7ff] border border-gray-100 shadow-xl">
            ...
            <p className="text-base">
              We are engaged in offering the best quality range of Roasted
              Peanuts White Plain (8 Piece). Our roasted peanuts are very
              popular among our clients for its sumptuous taste and premium
              quality. The peanuts are processed by highly skilled labour under
              supervision of professionals using advanced machines.
            </p>
          </div>
        </div>
      </div>

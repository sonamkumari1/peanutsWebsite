...
const WhatsAppButton = () => {
  return (
    <a
      href="https://wa.me/9352017239"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-10 right-10 w-[60px] h-[60px] bg-[#25d366] text-white rounded-full flex items-center justify-center text-[30px] shadow-md z-[100]
                 md:bottom-10 md:right-10
                 sm:w-[40px] sm:h-[40px] sm:bottom-5 sm:right-2.5 sm:text-[22px]"
    >
      <FaWhatsapp />
    </a>
  );
